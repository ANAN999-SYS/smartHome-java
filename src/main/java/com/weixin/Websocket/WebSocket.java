package com.weixin.Websocket;


import com.weixin.Mqtt.ActiveMQConsumer;
...
public class WebSocket {
    ...
    @OnOpen
    public void onOpen(Session session,@PathParam(value = "userId") String token ) {
        try {
